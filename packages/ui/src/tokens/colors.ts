 ...
 *
 * Rich color palette inspired by Tailwind CSS
 * Primary, Secondary, and Semantic colors are configurable via CSS variables
 * All other colors can be used directly via props
 */

// ============================================
// FULL COLOR PALETTE (Tailwind-like)
// ============================================

export const colors = {
  // Slate - Cool gray with a hint of blue
  slate: {
    50: '#f8fafc',
    100: '#f1f5f9',
    200: '#e2e8f0',
...
export type AllColors = ColorName | SemanticColor;

// ============================================
// DEFAULT BRAND COLORS (Configurable via CSS vars)
// ============================================
...
export const defaultBrandColors = {
  ...
  // Secondary - Supporting brand color (default: Slate)
  secondary: {
    50: colors.slate[50],
...
export function getColorClass(color: AllColors, shade: ColorScale, prefix: string = 'bg'): string {
