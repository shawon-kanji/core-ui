...
function TypographyPage() {
  return (
    <div className="space-y-8">
      ...
      <Showcase title="Headings" description="Semantic headings with automatic sizing.">
...
function ButtonPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Showcase title="Variants" description="Different visual styles for different contexts.">
        <HStack gap={4} wrap>
      ...
      <Showcase title="Semantic Colors" description="Use these for primary actions and feedback.">
        <HStack gap={3} wrap>
      ...
      <Showcase title="Palette Colors" description="Full color palette available via props.">
      ...
      <Showcase title="Outline Variant with Colors">
        <div className="flex flex-wrap gap-2">
      ...
      <Showcase title="Soft Variant with Colors">
        <div className="flex flex-wrap gap-2">
...
function InputPage() {
  return (
    <div className="space-y-8">
      ...
      <Showcase title="With Icons/Elements">
        <VStack gap={4} className="max-w-md">
          <Input
...
function CardPage() {
  return (
    <div className="space-y-8">
      ...
      <Showcase title="With Header and Footer">
      ...
      <Showcase title="Hoverable & Pressable">
        <HStack gap={4}>
...
function AvatarPage() {
  return (
    <div className="space-y-8">
      ...
      <Showcase title="Fallback Initials">
        <HStack gap={4}>
...
function StackPage() {
  return (
    <div className="space-y-8">
      ...
      <Showcase title="VStack (Vertical)">
        <VStack gap={3} className="p-4 border border-dashed border-gray-300 rounded">
      ...
      <Showcase title="HStack (Horizontal)">
        <HStack gap={3} className="p-4 border border-dashed border-gray-300 rounded">
      ...
      <Showcase title="Gap Sizes">
        <VStack gap={4}>
          {[1, 2, 4, 6, 8].map((gap) => (
            <div key={gap}>
              <Text size="sm" color="muted" className="mb-2">Gap: {gap}</Text>
              <HStack gap={gap as any} className="p-2 border border-dashed border-gray-300 rounded">
      ...
      <Showcase title="Alignment">
        <VStack gap={4}>
          {(['start', 'center', 'end'] as const).map((align) => (
            <div key={align}>
              <Text size="sm" color="muted" className="mb-2">align: {align}</Text>
              <HStack align={align} gap={3} className="p-4 h-24 border border-dashed border-gray-300 rounded">
      ...
      <Showcase title="Justify Content">
        <VStack gap={4}>
          {(['start', 'center', 'end', 'between', 'around'] as const).map((justify) => (
            <div key={justify}>
              <Text size="sm" color="muted" className="mb-2">justify: {justify}</Text>
              <HStack justify={justify} gap={3} className="p-4 border border-dashed border-gray-300 rounded">
...
function SkeletonPage() {
  return (
    <div className="space-y-8">
      ...
      <Showcase title="List Loading State">
        <VStack gap={4}>
          {[1, 2, 3].map((i) => (
            <HStack key={i} gap={4}>
              <SkeletonCircle size={40} />
